    ...
    <html><body>
      ...
      <article>
        <p>Attackers actively exploit
          <a href="/advisory_CVE-2026-1234_details"><img alt="this vulnerability"></a>
            ...
            entries=[
                {
                    ...
                    "description": (
                        ...
                        'advisory_CVE-2026-1234_details"><img alt="this '
                        'vulnerability"></a>.</p>'
...
def test_extract_article_text_combines_marked_siblings_under_unmarked_wrapper():
    source_html = """
...
def test_extract_article_text_excludes_candidate_with_own_collection_marker():
    source_html = """
    <article>
      <p>Primary story for CVE-2026-1234 contains exploitation evidence.</p>
      <p>Attackers actively exploit this vulnerability in the wild.</p>
