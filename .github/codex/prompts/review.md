...
- Report-generation correctness and API-error handling.
- Publish safety gates and generated markdown/html validity.
- Model/config drift, source attribution, and validation coverage.
