...
- **CVE ID**: Not yet assigned at time of reporting
...
- **CVE ID**: CVE identifier mentioned but not fully specified in source article
...
- **VMware vCenter**: Versions affected by CVE-2026-593; critical for virtualization infrastructure management
...
- **Public PoC Weaponization**: Rapid exploitation of CVE-2026-55040 (SharePoint) and CVE-2026-593 (vCenter) within days of PoC publication by Rapid7 and other researchers
